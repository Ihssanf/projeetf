...
public class Booking {
	...
	public Booking(jmrs.entity.Book book) {
		this.id = book.getBookId();
		this.name = book.getName();
		this.comment = book.getComment();
		this.startTime = jmrs.utils.DateUtils.timeFormat(book.getStartTime());
		this.endTime = jmrs.utils.DateUtils.timeFormat(book.getEndTime());
		this.type = BookType.BOOK;
		this.rowSpan = jmrs.utils.DateUtils.getRowSpan(startTime, endTime);
